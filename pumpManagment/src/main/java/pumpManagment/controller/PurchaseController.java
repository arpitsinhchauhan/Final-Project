...
public class PurchaseController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody AuthenticationRequest authenticationRequest)
        ...
        return ResponseEntity.ok(new AuthenticationResponse(
                ...
                petrolNozzle, dieselNozzle, xpPetrolNozzle, powerDieselNozzle));
    ...
    public ResponseEntity<List<extraPurchases>> updateExtraPurchase(@RequestBody List<extraPurchases> expenses) {
        ...
        for (extraPurchases expense : expenses) {
            ...
            if (existingEntry.isPresent()) {
                ...
                // Perform arithmetic addition instead of string concatenation
                existingExpense.setExtra_quantity(String.valueOf(Long.parseLong(existingExpense.getExtra_quantity()) + Long.parseLong(expense.getExtra_quantity())));
                existingExpense.setExtra_total(String.valueOf(Long.parseLong(existingExpense.getExtra_total()) + Long.parseLong(expense.getExtra_total())));
                existingExpense.setExtra_vat(String.valueOf(Long.parseLong(existingExpense.getExtra_vat()) + Long.parseLong(expense.getExtra_vat())));
                existingExpense.setExtra_cess(String.valueOf(Long.parseLong(existingExpense.getExtra_cess()) + Long.parseLong(expense.getExtra_cess())));
                existingExpense.setExtra_jtcpercentage(String.valueOf(Long.parseLong(existingExpense.getExtra_jtcpercentage()) + Long.parseLong(expense.getExtra_jtcpercentage())));
                existingExpense.setExtra_total_purchase(existingExpense.getExtra_total_purchase() + expense.getExtra_total_purchase());
...
//    }
    ...
    public ResponseEntity<ApiResponse> saveOrUpdatePowerDieselStock(@RequestBody PowerDieselStockRequest powerRequest) {
        ...
        if (powerdieseldailystockRepository.countByDate(date, userId) == 0) {
            ...
            System.out.println("Power Diesel stock saved for date " + date);
            ...
            System.out.println("Power Diesel stock updated for date " + date);
